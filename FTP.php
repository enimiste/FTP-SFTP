...
/**
 * Source : CodeIgniter Cutomised
 */
class FTP extends Abstract_FTP
{
    ...
    function download_asynch($rempath, $locpath, $mode = 'auto')
    {
        ...
        $result = @ftp_nb_get($this->conn_id, $locpath, $rempath, $mode);
    ...
    {
        //changer de dossier
        if (ftp_chdir($this->conn_id, $rempath)) {
     ...
     * ['isdir'=>true/false, 'perms'=>, 'number'=>, 'owner'=>, 'group'=>, 'size'=>, 'month'=>, 'day'=>, 'time/year'=>, 'name'=>]
    ...
    {
        $parsed = array();
        $list = ftp_rawlist($this->conn_id, $rempath);
        $i = 0;
